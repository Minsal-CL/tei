...
* extension[RamaGES]
  ...
  * value[x] only CodeableConcept
  * value[x] from VSRamaGES (required)
  * value[x].coding 0..1 MS
  * value[x].coding.code 0..1 MS
  * value[x].coding.system 0..1 MS
  * value[x].coding.display 0..1 MS
  * value[x].text 0..1 MS
  * value[x].text ^short = "Descripción en texto libre de la rama, en caso de no tener un código específico para la rama GES"


* extension[SubRamaGES]
  * ^short = "Indica una sub especificación sobre el problema de salud GES"
  * value[x] only CodeableConcept
  * value[x] from VSSubRamaGES (required)
  * value[x].coding 0..1 MS
    * code 0..1 MS
    * system 0..1 MS
    * display 0..1 MS
