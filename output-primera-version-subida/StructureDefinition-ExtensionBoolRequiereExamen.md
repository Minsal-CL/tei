# ExtBool Requiere Examen - Tiempos de Espera Interoperable v0.2.3
...
| | |
| :--- | :--- |
| *Official URL*:https://interoperabilidad.minsal.cl/fhir/ig/tei/StructureDefinition/ExtensionBoolRequiereExamen | *Version*:0.2.3 |
| Draft as of 2026-07-22 | *Computable Name*:ExtensionBoolRequiereExamen |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/hl7.fhir.cl.minsal.tei|current/StructureDefinition/StructureDefinition-ExtensionBoolRequiereExamen.json)
