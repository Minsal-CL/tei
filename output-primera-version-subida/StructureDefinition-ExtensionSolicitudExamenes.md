# ExtBool Solicitud Examenes - Tiempos de Espera Interoperable v0.2.3
...
| | |
| :--- | :--- |
| *Official URL*:https://interoperabilidad.minsal.cl/fhir/ig/tei/StructureDefinition/ExtensionSolicitudExamenes | *Version*:0.2.3 |
| Draft as of 2026-07-22 | *Computable Name*:ExtensionSolicitudExamenes |
...
* Examples for this Extension: [CarePlan/CarePlanAtencionEjemplo](CarePlan-CarePlanAtencionEjemplo.md)

You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/hl7.fhir.cl.minsal.tei|current/StructureDefinition/StructureDefinition-ExtensionSolicitudExamenes.json)
