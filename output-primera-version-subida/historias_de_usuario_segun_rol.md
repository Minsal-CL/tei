# Historias De Usuario Segun Rol - Tiempos de Espera Interoperable v0.2.3
...
* Verificar que el referenciador puede listar las solicitudes de interconsultas ordenadas por: 
* Nombres y apellidos
...
* Verificar que un terminador puede ver la información de la solicitud de interconsulta con la consiguiente información: 
* Nombres y apellidos del paciente
* Número de identificación
* Estado del paciente
* Numero de solicitud
...
El usuario es egresado de la Lista de Espera por alguna de las 20 causales definidas en la [Norma Técnica N°118](https://drive.google.com/file/d/1kZBAY7E-Rmy3DxGCMP3emotxEWh5nLEy/view).
